 ...
 * Every CancelKits transactional email wraps its body in this HTML scaffold.
...
export interface LayoutOptions {
	/** The preheader / preview text visible in inbox list views. */
	preheader?: string;
	/** Recipient's user ID — used to build the unsubscribe link. */
	userId?: string;
	/** Recipient email — used as fallback for unsubscribe token. */
	email?: string;
}
...
export function emailLayout(body: string, options: LayoutOptions = {}): string {
	...
	const unsubToken = userId || encodeURIComponent(email || '');
...
/* ────────────────────────────────────
   Shared inline-style building blocks
   ──────────────────────────────────── */
...
export const styles = {
	...
	danger: 'color:#ff4444;',
	ctaButton:
		'display:inline-block;padding:14px 28px;border-radius:100px;background-color:#00ff88;color:#000000;font-size:15px;font-weight:700;text-decoration:none;text-align:center;',
	ctaButtonOutline:
		'display:inline-block;padding:12px 24px;border-radius:100px;border:1px solid #2a2a2a;background-color:#111111;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;text-align:center;',
	...
	badge:
		'display:inline-block;padding:4px 10px;border-radius:100px;font-size:12px;font-weight:600;',
	badgeAccent:
		'display:inline-block;padding:4px 10px;border-radius:100px;font-size:12px;font-weight:600;background-color:rgba(0,255,136,0.15);color:#00ff88;border:1px solid rgba(0,255,136,0.3);',
	badgeDanger:
		'display:inline-block;padding:4px 10px;border-radius:100px;font-size:12px;font-weight:600;background-color:rgba(255,68,68,0.15);color:#ff4444;border:1px solid rgba(255,68,68,0.3);',
} as const;
