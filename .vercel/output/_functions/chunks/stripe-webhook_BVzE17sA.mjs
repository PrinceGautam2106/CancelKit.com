...
import { n as getPlanFromPriceId, r as stripe } from "./stripe_CTivRJRB.mjs";
import { a as resend, i as EMAIL_DEFAULTS } from "./layout_BnuVbSgo.mjs";
			...
			case "invoice.payment_failed": {
				...
				try {
					await supabase.from("alerts").insert({
						...
						type: "payment_failed",
						message: `Your SubZaps payment of $${amount} failed. Please update your payment method within 3 days.`,
