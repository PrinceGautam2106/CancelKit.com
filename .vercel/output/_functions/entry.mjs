...
var middlewareSecret = "69b48165-16e6-4cef-bd2c-a5e003ce6df6";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/customer-portal.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/lemon-webhook\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "lemon-webhook",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/api/lemon-webhook.ts",
			"pathname": "/api/lemon-webhook",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNyZ215c2prcG1kdWh4aGhid3JjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODk0NDgzNDMsImV4cCI6MjEwNTAyNDM0M30.6j_OT1oVOsZzMZjtuHYZBEOZrsrcVZvBChWoahLm42o",
			"PUBLIC_SUPABASE_URL": "https://srgmysjkpmduhxhhbwrc.supabase.co",
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "69b48165-16e6-4cef-bd2c-a5e003ce6df6") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
