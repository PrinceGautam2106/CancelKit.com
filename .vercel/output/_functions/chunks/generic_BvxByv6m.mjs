...
import { D as renderTemplate, F as createAstro, N as unescapeHTML, O as maybeRenderHead, c as createConsoleLogger, k as addAttribute, x as spreadAttributes } from "./sequence_B-6XR2Ys.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_sHnaWBpd.mjs").catch((e) => {
