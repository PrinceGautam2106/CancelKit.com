...
var $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
	...
	const organizationSchema = {
		...
		sameAs: ["https://x.com/PrinceGaut5631", "https://www.linkedin.com/in/prince-gautam-21a308292"],
		contactPoint: {
			"@type": "ContactPoint",
	...
	return renderTemplate`<html${addAttribute(lang, "lang")}><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description"${addAttribute(description, "content")}>${keywords && renderTemplate`<meta name="keywords"${addAttribute(keywords, "content")}>`}<meta name="robots"${addAttribute(robotsContent, "content")}><meta name="generator"${addAttribute(Astro.generator, "content")}><meta name="theme-color" content="#050505"><meta name="msapplication-TileColor" content="#050505"><link rel="canonical"${addAttribute(canonicalUrl, "href")}><link rel="icon" type="image/png" href="/favicon-96x96.png" sizes="96x96"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="shortcut icon" href="/favicon.ico"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><meta name="apple-mobile-web-app-title" content="CancelKits"><link rel="manifest" href="/site.webmanifest"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="dns-prefetch" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500&family=Inter:wght@400;500;600&display=swap" rel="stylesheet"><meta property="og:type" content="website"><meta property="og:site_name" content="CancelKits"><meta property="og:locale"${addAttribute(ogLocaleMap[lang] ?? "en_US", "content")}><meta property="og:title"${addAttribute(resolvedOgTitle, "content")}><meta property="og:description"${addAttribute(resolvedOgDescription, "content")}><meta property="og:image"${addAttribute(imageUrl, "content")}><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="CancelKits — find and cancel forgotten subscriptions"><meta property="og:url"${addAttribute(canonicalUrl, "content")}><meta name="twitter:card" content="summary_large_image"><meta name="twitter:site" content="@PrinceGaut5631"><meta name="twitter:creator" content="@PrinceGaut5631"><meta name="twitter:title"${addAttribute(resolvedTwitterTitle, "content")}><meta name="twitter:description"${addAttribute(resolvedTwitterDescription, "content")}><meta name="twitter:image"${addAttribute(imageUrl, "content")}><meta name="twitter:image:alt" content="CancelKits subscription cancellation dashboard">${hreflang === "home" && [
		{
			lang: "en",
...
var $$Footer = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${maybeRenderHead($$result)}<footer class="cancelkit-footer" data-astro-cid-jo6i4kqk><div class="footer-container" data-astro-cid-jo6i4kqk><div class="footer-grid" data-astro-cid-jo6i4kqk><!-- Column 1: Brand --><div class="footer-col footer-col--brand" data-astro-cid-jo6i4kqk><a class="footer-logo" href="/" aria-label="CancelKits home" data-astro-cid-jo6i4kqk><img class="footer-logo__icon" src="/favicon.svg" alt="" width="26" height="26" data-astro-cid-jo6i4kqk><span class="footer-logo__text" data-astro-cid-jo6i4kqk>Cancel<span data-astro-cid-jo6i4kqk>K<span class="footer-logo__accent" data-astro-cid-jo6i4kqk>i</span>ts</span></span></a><p class="footer-tagline" data-astro-cid-jo6i4kqk>Cancel subscriptions. Keep your money.</p><!-- Social Links (SVG Icons, no libraries) --><div class="footer-socials" aria-label="Social links" data-astro-cid-jo6i4kqk><!-- Twitter / X Icon --><a href="https://x.com/PrinceGaut5631" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Prince Gautam on Twitter / X" data-astro-cid-jo6i4kqk><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" data-astro-cid-jo6i4kqk><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" data-astro-cid-jo6i4kqk></path></svg></a><!-- LinkedIn Icon --><a href="https://www.linkedin.com/in/prince-gautam-21a308292" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Prince Gautam on LinkedIn" data-astro-cid-jo6i4kqk><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" data-astro-cid-jo6i4kqk><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.2V10.9H6.46M7.83 6.64a1.65 1.65 0 1 0 0 3.3 1.65 1.65 0 0 0 0-3.3z" data-astro-cid-jo6i4kqk></path></svg></a></div><p class="footer-coffee" data-astro-cid-jo6i4kqk>Made with ☕ for people tired of being charged</p></div><!-- Column 2: Product --><div class="footer-col" data-astro-cid-jo6i4kqk><h3 class="footer-col-title" data-astro-cid-jo6i4kqk>Product</h3><ul class="footer-links" data-astro-cid-jo6i4kqk>${[
		{
			label: "Dashboard",
			href: "/dashboard"
		},
	...
	].map((link) => renderTemplate`<li data-astro-cid-jo6i4kqk><a${addAttribute(link.href, "href")} data-astro-cid-jo6i4kqk>${link.label}</a></li>`)}</ul></div></div><!-- Bottom Bar --><div class="footer-bottom" data-astro-cid-jo6i4kqk><p class="footer-copyright" data-astro-cid-jo6i4kqk>© ${(/* @__PURE__ */ new Date()).getFullYear()} CancelKits. All rights reserved.</p><!-- Language Switcher --><div class="lang-switcher" id="lang-switcher" data-astro-cid-jo6i4kqk><button class="lang-toggle" type="button" aria-expanded="false" aria-haspopup="listbox" aria-label="Select language" data-astro-cid-jo6i4kqk><svg class="lang-globe" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-jo6i4kqk><circle cx="12" cy="12" r="10" data-astro-cid-jo6i4kqk></circle><path d="M2 12h20" data-astro-cid-jo6i4kqk></path><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10A15.3 15.3 0 0 1 12 2z" data-astro-cid-jo6i4kqk></path></svg><span class="lang-current" data-astro-cid-jo6i4kqk>English</span><svg class="lang-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-jo6i4kqk><polyline points="6 15 12 9 18 15" data-astro-cid-jo6i4kqk></polyline></svg></button><ul class="lang-menu" role="listbox" aria-label="Available languages" data-astro-cid-jo6i4kqk><li role="option" data-astro-cid-jo6i4kqk><a href="/" data-lang="en" data-astro-cid-jo6i4kqk><span class="lang-flag" data-astro-cid-jo6i4kqk>🇺🇸</span> English</a></li><li role="option" data-astro-cid-jo6i4kqk><a href="/es/" data-lang="es" data-astro-cid-jo6i4kqk><span class="lang-flag" data-astro-cid-jo6i4kqk>🇪🇸</span> Español</a></li><li role="option" data-astro-cid-jo6i4kqk><a href="/fr/" data-lang="fr" data-astro-cid-jo6i4kqk><span class="lang-flag" data-astro-cid-jo6i4kqk>🇫🇷</span> Français</a></li><li role="option" data-astro-cid-jo6i4kqk><a href="/de/" data-lang="de" data-astro-cid-jo6i4kqk><span class="lang-flag" data-astro-cid-jo6i4kqk>🇩🇪</span> Deutsch</a></li><li role="option" data-astro-cid-jo6i4kqk><a href="/pt/" data-lang="pt" data-astro-cid-jo6i4kqk><span class="lang-flag" data-astro-cid-jo6i4kqk>🇧🇷</span> Português</a></li></ul></div><div class="footer-legal-links" data-astro-cid-jo6i4kqk><a href="/privacy" data-astro-cid-jo6i4kqk>Privacy</a><span class="footer-sep" aria-hidden="true" data-astro-cid-jo6i4kqk>•</span><a href="/terms" data-astro-cid-jo6i4kqk>Terms</a><span class="footer-sep" aria-hidden="true" data-astro-cid-jo6i4kqk>•</span><a href="/cookies" data-astro-cid-jo6i4kqk>Cookies</a></div></div></div></footer>${renderScript($$result, "/Users/princegautam/cancelkit.com/src/components/Footer.astro?astro&type=script&index=0&lang.ts")}`;
